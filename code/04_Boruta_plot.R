# Produce the plot of the Boruta table for the paper
...
load("./results/Boruta_results_es.RData")
...
# ggsave(filename = "./figures/Boruta_table.pdf", plot = p, width = 10, height = 6, dpi = 300)
...
# write.csv(wide_data, "./tables/Boruta_results_es.csv", row.names = FALSE)